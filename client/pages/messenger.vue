        ...
        <div class="_1messenger">
          ...
          <div class="_1messenger_left">
            ...
            <div class="_1messenger_chat_list_all _1scrollbar">
              <!-- Items -->
              <div
                class="_1messenger_chat_list"
                v-for="(Chat, i) in chatlist"
                :key="i"
              >
                <div class="_1messenger_chat_pic">
                  <img
                    src="https://api.hombolttech.net/img/profile.png"
                    alt=""
                    title=""
                    class="_1messenger_chat_img"
                  />
                </div>
                <div class="_1messenger_chat_details">
                  <!--
                  <p class="_1messenger_chat_name">{{ Chat.user.username }}</p>
                  <p class="_1messenger_chat_text">{{ Chat.msg }}</p>
                -->
                </div>
              ...
              <!-- <div class="_1messenger_chat_list" v-for="(item, index) in 5" :key="index"> 
                             <div class="_1messenger_chat_list" >
                                <div class="_1messenger_chat_pic">
                                    <img src="https://api.hombolttech.net/img/profile.png" alt="" title="" class="_1messenger_chat_img">
                                </div>
                                <div class="_1messenger_chat_details">
                                    <p class="_1messenger_chat_name">{{Chat.username}}</p>
                                    <p class="_1messenger_chat_text">Hay! What's up?</p>
                                </div>
                                <div class="_1messenger_chat_time">
                                    <p class="_1messenger_chat_time_text">12:00PM</p>
          ...
          <div class="_1messenger_right">
              ...
              <div class="_1messenger_right_header_left _active">
                <a href="" class="_1messenger_right_pic">
                  <img
                    ...
                    alt=""
                    title=""
                    class="_1messenger_right_img"
                  />
                </a>
                <div class="_1messenger_right_heder_details">
                  <a href="" class="_1messenger_right_name _1text_overflow">
                    Administratordfgh who</a
                  >
                </div>
              </div>
            ...
            <div class="_1messenger_right_chat">
              <div class="_1chat_all _1scrollbar">
                ...
                <div v-for="(Chat, i) in chatlist" :key="i" class="_1fri_mess">
                  
                  <div v-if="authUser.id != Chat.sender_id">

                    <div v-if="Chat.deleted_id ==  NUll || Chat.deleted_id == Chat.sender_id"                    
                      class="_1fri_mess_main"
                    >
                      <div 
                      
                       class="_1fri_mess_mess">
                        <p class="_1fri_mess_text">{{ Chat.msg }}</p>
                    ...
                    <div
                      v-if="Chat.deleted_id == sender_id || NULL"
                      class="_1fri_pic"
                    >
                      <img
                        src="https://api.hombolttech.net/img/profile.png"
                ...
                <template>
                  <div v-for="(Chat, i) in chatlist" :key="i">
                    <div v-if="authUser.id == Chat.sender_id">
                      <!-- Own message -->
                      <div
                        v-if="authUser.id != Chat.deleted_id || NULL"
                        class="_1own_mess"
                      >
                        <div class="_1own_mess_main">
                          ...
                          <div class="_1own_mess_mess">
                            <p class="_1own_mess_text">{{ Chat.msg }}</p>
              ...
              <div class="_1mess_textarea">
                <div class="_1mess_textarea_top">
                  <ul class="_1mess_textarea_options">
                    ...
                    <li>
                      <svg
                        style="enable-background:new 0 0 512 512;width:22px;height:auto"
                  ...
                  <div class="_1mess_textarea_input">
                    ...
                    >
                      <textarea
                        ...
                        rows="2"
                        class="ivu-input"
                        style="height: 34px; min-height: 34px; max-height: 130px; overflow-y: hidden;"
                      ></textarea>
                    </div>
                  </div>
                  <div class="_1mess_textarea_send">
                    <i class="fas fa-paper-plane" @click="sent"></i>
                  </div>
                </div>
              </div>
              <!-- Status Box -->
...
export default {
  ...
  computed: {
    ...mapGetters({ userInfo: "getUserInfo", authUser: "getAuthUser" })
  },

  methods: {
    async sent() {
      this.chatBox.sender_id = this.userInfo.id;
      const res = await this.$axios.$post("msg", this.chatBox);
    //  console.log(res)
      (this.chatBox.msg = ""), (this.chatBox.sender_id = 0);
    //   this.socket.emit('test', this.chatBox.msg)
